...
categories: [Project]
tags: [opencv, cpp, visual-studio, visualization, python, gnuplot]
---
## 목표
...
![image](/assets/img/posts/gnuplot/001-149084635-7825705c-b600-48a0-990e-44ecdc312081.png)
...
![image](/assets/img/posts/gnuplot/002-149083515-fc3cb5a0-d04d-4104-a420-900aff2e78a4.webp)

![image](/assets/img/posts/gnuplot/003-149083677-3dd52b73-cb84-40a3-98c1-e3929b0472ca.webp)
...
![image](/assets/img/posts/gnuplot/004-149084849-dad0415c-9a60-4e30-a076-49ee70a83dbb.png)
...
![image](/assets/img/posts/gnuplot/005-149082396-6882ce1b-180c-42a3-9b30-46f2e2a8aa81.png)

![image](/assets/img/posts/gnuplot/006-149085025-d21972dd-d06a-42ca-8531-c7f8a9658f61.webp)
...
그래서 data.dat 파일에 write해줄 때, 행 순서를 반전시키도록 np_arr[i] 대신 np_arr[len(np_arr)-1-i]를 읽어오면 해결할 수 있다. (아래 코드 참고)
...
for i in range(len(np_arr)):
    for j in range(len(np_arr[1])):
        ...
        file.write(str(j) + " " + str(i) + " " + str(np_arr[len(np_arr)-1-i][j]))  # i -> len(np_arr)-1-i 로만 바꿔주면 된다.
        file.write("\n")
    file.write("\n")
file.close()
```

![image](/assets/img/posts/gnuplot/007-149082222-eaeffd2e-9704-48ae-9505-1d89cc7f31ef.webp)
