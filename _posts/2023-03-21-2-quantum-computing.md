---
title: 양자 컴퓨팅이란?
description: 큐비트의 중첩과 얽힘으로 특정 문제를 기존 컴퓨터보다 빠르게 푸는 양자 컴퓨팅의 원리와 활용 분야, 현재의 한계를 정리한다.
date: 2023-03-21 10:00:00 +0900
slug: '(2)QuantumComputing'
categories: [ETC]
...
큐비트는 양자 중첩 원리에 따라 0과 1의 상태를 동시에 가질 수 있다.
...
그래도 암호학, 최적화, 인공 지능 같은 분야에서는 기존 컴퓨팅으로 풀기 어려운 문제를 해결할 잠재력이 분명한 만큼, 앞으로의 발전을 지켜볼 만하다.
