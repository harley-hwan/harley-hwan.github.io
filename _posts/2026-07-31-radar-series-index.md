...
0~3편은 24 GHz 근거리 CW 를 기준으로 쓰고, 4~5편은 X 밴드 감시 레이다로 기준을 옮긴다. 파형이 바뀌면 숫자 감각이 통째로 달라지기 때문이다. 0~4편이 안테나에 들어온 전파를 검출 목록으로 바꾸는 과정이라면, 5편은 그 목록을 화면의 트랙 심볼로 바꾸는 과정이다.
