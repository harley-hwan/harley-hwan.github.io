...
description: 백준 9251 LCS (c++)
date: 2021-09-15 10:00:00 +0900
categories: [Algorithm, Baekjoon]
tags: [baekjoon, algorithm, dp]
---
![image](/assets/img/posts/boj-9251-lcs/001-133319588-0bb6819c-4444-4a63-8e7d-9687298a7f18.webp)
...
### 풀이 과정
---
+ 예제에서 주어진 ACAYKP 와 CAPCAK를 예로 하면,  첫 입력인 ACAYKP에서 A를 먼저 고르고 CAPCAK의 왼쪽에서부터 하나씩 A와 일치하는지 비교하고, 다음은 C를 고르고 CAPCAK의 왼쪽에서부터 하나씩 C와 일치하는지를 비교하는 식으로, 그 시점까지의 공통 부분 수열의 최대 길이를 dp라는 배열에 저장하는 것을 반복한다.
