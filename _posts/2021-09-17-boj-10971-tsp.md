...
description: 백준 10971 외판원 순회 문제 (c++)
date: 2021-09-17 10:00:00 +0900
categories: [Algorithm, Baekjoon]
tags: [baekjoon, algorithm, brute-force, backtracking]
---
![image](/assets/img/posts/boj-10971-tsp/001-133772910-3dcb2d57-82f1-49ed-b0b2-ed3deca5bb90.webp)
...
+ 아래와 같은 루트들의 비용이 똑같다는 것은 간단히 알 수 있다.
  ...
  + 2 3 1 2
  + 3 1 2 3
+ 즉, 맨 앞 하나가 어떤 값이던 간에 변화가 없다. 그래서 하나를 제외하고 반복. N!과 (N-1)!의 차이를 만든다. 가장 큰 값 하나를 곱하는 것을 제외하고 작업한다는 것은 큰 차이이다.
