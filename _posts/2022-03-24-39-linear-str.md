...
description: "C#에서 동적 배열(List)과 연결 리스트(LinkedList)를 직접 구현하며 각 연산의 시간 복잡도와 동작 원리를 살펴본다."
date: 2022-03-24 10:00:00 +0900
slug: '(39)LinearStr'
categories: [Dev, CSharp]
series: csharp
series_order: 39
tags: [csharp, unity, syntax, array, list, linkedlist]
---
## 내용
...
![capture1](/assets/img/posts/39-linear-str/001-159429242-00c0c876-ba31-48dc-ad07-6c49d912e336.png)

<br/>

##### RemoveAt(2)한 결과

![capture2](/assets/img/posts/39-linear-str/002-159429253-12991448-ccbc-4923-a8cf-8aeb08f97b08.png)
...
![image](/assets/img/posts/39-linear-str/003-159436007-c5dcea8e-4e22-4479-b841-68d849693649.png)

<br/>

##### Remove(node)한 결과

![image](/assets/img/posts/39-linear-str/004-159436034-bbe1cdf4-3259-4e1a-84e3-f1fd50ae55e8.png)
