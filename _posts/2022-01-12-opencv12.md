...
series: opencv
series_order: 12
tags: [opencv, cpp, visual-studio, threshold, binary-image]
---
## 목표
...
모폴로지 연산에도 여러가지 종류가 있는데, Erosion(침식), Dilatation(팽창), Opening(열림), Closing(닫힘) 등이 있다.
...
침식 연산은 이 커널을 이미지 위에서 이동시키면서 커널 영역 안의 최솟값을 중앙 픽셀 값으로 바꾸는 방식으로 동작하며, 그 결과 물체의 흰색 영역이 깎여 나간다. 구체적인 과정은 아래 실습에서 살펴본다.
...
![image](/assets/img/posts/opencv12/001-149255972-e89a5532-20dc-469f-920c-02db26926fa7.png)

<br/>

내가 설정한 커널 정보에 따라 3x3 크기마다 최솟값을 중앙값으로 설정해준다.

![image](/assets/img/posts/opencv12/002-149256338-c9d9305a-5b54-4c49-9543-0b225a27d57f.png)
![image](/assets/img/posts/opencv12/003-149256511-e418df97-08c8-4a6a-9ede-38eb4ea62089.png)

이 과정을 반복하면, 아래의 결과가 된다.

![image](/assets/img/posts/opencv12/004-149256161-00713af2-5d54-4a43-a063-5aded6b9727c.png)
...
![image](/assets/img/posts/opencv12/005-149256968-ceda02b3-d071-4147-bf52-5d9654c09499.png)

내가 설정한 커널 정보에 따라 3x3 크기마다 최댓값을 중앙값으로 설정해준다.

![image](/assets/img/posts/opencv12/006-149257074-4a8838de-85fa-4281-8a5a-af5e75181ae8.png)
![image](/assets/img/posts/opencv12/007-149257111-764053d2-bfdf-49e8-8e3c-bdd417783ed7.png)

이 과정을 반복하면, 아래의 결과가 된다.

![image](/assets/img/posts/opencv12/008-149257198-d681a956-bf0a-470c-8f4f-85bf96c36a29.png)
...
![image](/assets/img/posts/opencv12/009-149257369-53566c37-733d-4351-a35d-a553bdee7740.png)

![image](/assets/img/posts/opencv12/010-149257430-987d5520-9031-498d-b623-9aeac78cf19a.png)
