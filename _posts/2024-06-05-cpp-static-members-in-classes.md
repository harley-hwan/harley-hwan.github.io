...
categories: [Dev, C++]
tags: [cpp, programming, static-keyword, static-member-variable, static-member-function]
---
...
클래스 내부에서 static 멤버 변수를 선언할 때는 `static` 키워드를 사용한다. 일반적으로 클래스의 헤더 파일(`.h`)에서 선언한다.
