...
tags: [opencv, cpp, visual-studio, noise-removal, gaussian-filter, gaussian-blur]
---
## 목표
...
커널을 이동시키며 행렬의 값들을 교체하는 계산 방식 자체는 평균 필터와 동일하므로, 이전 글에서 다룬 평균 필터의 계산 과정을 복습 삼아 다시 보자.
이 계산 작업을 반복하면 이미지의 픽셀들 중 유독 튀던 값들이 주변값에 의해 부드러워(?)진다.

![image](/assets/img/posts/opencv8/001-148881478-e4d0df32-cb19-4f78-a85a-12c1b9d93886.webp)

![image](/assets/img/posts/opencv8/002-148881663-98099297-e1d4-4856-b071-b5f3ec72e789.webp)
...
![image](/assets/img/posts/opencv8/003-148882162-616e6800-a9ac-4c3e-bf67-7835be0bfd1b.webp)
...
GaussianBlur(src, dst, kernel, sigma_x, sigma_y, borderType)
- src: 입력 이미지
- dst: 출력 이미지
...
![image](/assets/img/posts/opencv9/001-148894671-1a439f67-aad6-4e40-a03d-c99ab963e63d.webp)

![image](/assets/img/posts/opencv9/002-148894976-3061e894-9930-46bb-9426-33041c9eb4be.webp)

Gaussian Filter는 Gaussian 함수를 표본화하여 mask의 계수를 결정한다.
아래의 이미지 와 같이 3x3 Gaussian Filter이며, 모든 계수는 합이 1이 된다.

![image](/assets/img/posts/opencv9/003-148895593-10b208cf-e6c6-4158-ab29-2512ff2a3186.webp)
...
![image](/assets/img/posts/opencv9/004-148896165-087b6932-210c-43c2-81c6-b327c99ea630.webp)
