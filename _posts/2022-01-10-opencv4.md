...
series: opencv
series_order: 4
tags: [opencv, cpp, visual-studio, video-capture]
---
## 목표
...
추가로, set 함수로 해상도를 설정할 수 있다. 640 x 480 해상도가 기본값이며, 1920 x 1080 으로 설정하면 더 큰 화면의 웹캠 화면을 확인할 수 있다.

과거에는, CV_CAP_PROP_FRAME_WIDTH / CV_CAP_PROP_FRAME_HEIGHT 를 통해 해상도 설정을 했는데, 더 이상 CV_ 를 앞에 붙이지 않는다고 하니 주의하자.

![image](/assets/img/posts/opencv4/001-148736396-281b3393-ff9f-410c-a964-4939fa3a8b64.png)
...
![image](/assets/img/posts/opencv4/002-148734228-6ff6f6e6-40bc-4ca2-a611-b7797da97c05.png)

<br/>
<br/>

그래서 카메라가 내장되어 있는 노트북으로 같은 코드를 따로 실행해봤고, 웹캠 영상이 정상적으로 출력되는 것을 확인했다.
