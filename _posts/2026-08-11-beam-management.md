...
[10장](/posts/phased-array-radar/)이 남긴 것은 조향 가능한 빔이다. 마이크로초면 어디로든 옮길 수 있고, 부엽이 관리되고, 캘리브레이션으로 유지되는 빔 — 그런데 빔이 준비됐다는 것과 빔을 잘 쓴다는 것은 다른 문제다. 이 장은 그 빔으로 **재고**(각도 측정), **찾고**(탐색), **나누는**(자원 관리와 빔그리드) 이야기다.
