...
# : : tensor([85.5000, 92.3000, 78.9000, 95.1000, 88.7000])
...
# : : tensor([86.6000, 88.2000, 89.0000])

# (dim=1: )
stud_avg = grades.mean(dim=1)
print(f"학생별 평균: {stud_avg}")
# : : tensor([87.6667, 91.6667, 81.6667, 91.0000, 87.6667])
```
...
# : dim=0 sum shape: torch.Size([4, 3])
...
probs = torch.rand(10)
print(f"확률 분포: {probs}")
# : : tensor([0.1947, 0.9379, 0.0840, 0.4652, 0.7508, 0.9644, 0.8788, 0.0567,
# 0.9274, 0.5426])
