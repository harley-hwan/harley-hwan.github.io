...
트랙이 다시 다음 빔을 어디로 보낼지 정하는 쪽은 [10장](/posts/phased-array-radar/)에 있다. 여기서 계산한 공분산이 거기서 갱신 주기의 기준이 되고, 그 순간 앞의 α-β 상수는 쓸 수 없게 된다. 전체 목차는 [여기](/posts/radar-series-index/).
