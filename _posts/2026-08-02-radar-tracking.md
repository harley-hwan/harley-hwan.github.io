...
**갱신 주기가 일정하지 않다.** 위상 배열은 표적마다 다른 주기로 조사한다. $F$ 와 $Q$ 를 $T$ 의 함수로 매번 다시 만들어야 하고, 5절의 α-β 상수는 쓸 수 없다.
...
시리즈는 여기까지 왔다. [0편](/posts/radar-fundamentals/)의 단위와 데시벨에서 시작해 IQ, CW 와 FMCW, CW 수신 체인, 펄스 파형을 지나 트랙까지, 안테나에 들어온 전파가 화면의 트랙 심볼이 되기까지의 한 줄이 이어졌다. 전체 지도는 [목차](/posts/radar-series-index/)에 있다.
